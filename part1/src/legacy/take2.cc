...
This is an outdated version of the cache simulator, please refer the latest release.
...
int main(int argc, char *argv[])
{
    ...
    long line=1;
    int base=1;
    int temp1=0,temp2=0,temp3=0,temp4=0,temp6=0,temp7=0;
    //int temp6=INT_MAX;
            ...
            if(rep_policy == '0')
            {
                ...
                if(write_policy == '0')
                {
                    ...
                    if(associativity == '1')
                    {
                        ...
                        {
                            if(read_write == 'r') read_hit_count++;
                    ...
                    else
                    {
                        ...
                        if(hit_flag ==1)
                        {
                            ...
                            {
                                write_hit_count++;
                                sm_dirty_bit[(temp1*cache_blocks_number) + index_bits_decimal] = 1;
                ...
                else if(write_policy == '1')
                {
                    ...
                    if(associativity == '1')
                    {
                        ...
                        {
                            if(read_write == 'r') read_hit_count++;
                            else if(read_write == 'w') write_hit_count++;
                        }
                        else
                        {
                            if(read_write == 'r')
                            ...
                            else if(read_write == 'w') write_miss_count++;
                            traffic++;
                        }
                    }
                    ...
                    else
                    {
                        ...
                        for(j=0;j<sets;j++)
                        {
                            if(strcmp(set_mapped_cache_tag_arrays[(j*cache_blocks_number) + index_bits_decimal],tag_bits)==0)
                            {
                                ...
                                lfu_counter[(j*cache_blocks_number) + index_bits_decimal]++;
                ...
                else if(write_policy == '1')
                {
                    ...
                    if(associativity == '1')
                    {
                        ...
                        else
                        {
                            ...
                            {
                                read_miss_count++;
                                strcmp(direct_mapped_cache_tag_array[index_bits_decimal],tag_bits);
                            }
                            else if(read_write == 'w') write_miss_count++;
                            traffic++;
                        }
